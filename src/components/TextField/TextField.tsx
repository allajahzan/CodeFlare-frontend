function TextField({ text, label }: { text: string, label: string }) {
    return (
        <div className='flex flex-col relative m-2'>
            <input id={label} className='p-4 bg-transparent border-2 border-black border-opacity-20 font-medium rounded-lg outline-none' type="text" value={text} readOnly autoComplete="off" />
