...
function VideoCall({
    ...
    // Set stream when component mounts
    useEffect(() => {
        ...
        <div className="flex flex-col gap-5 items-center justify-center h-screen p-5">
           ...
           bg-background border rounded-2xl shadow-custom relative p-2 "
                ...
                <div className={`grid ${getGridClass()} gap-2 w-full h-full`}>
                    {participants.map((participant) => (
                        ...
                        >
                            ...
                            {user?._id !== participant.id || isVideoMute ? (
                                // Muted
            ...
            <div className="flex items-center justify-center gap-3">
                <div className="flex items-center justify-center gap-3 p-2 bg-black/20 dark:bg-sidebar-backgroundDark backdrop-blur-sm rounded-full">
                    <motion.div
