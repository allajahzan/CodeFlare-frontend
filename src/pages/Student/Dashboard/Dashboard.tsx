...
const calculatePadding = (isShrink: boolean, isSmall: boolean): React.CSSProperties => {
  return {
    ...
    paddingLeft: isSmall ? "20px" : isShrink ? "68px" : "220px",
  };
};
...
function Dashboard() {
  const [style, setStyle] = useState<React.CSSProperties>({ transition: "all 0.4s ease-in-out" });
    ...
    <div>
      ...
      <div className="flex h-[100vh]">
        ...
        <div style={style} className="w-full bg-white">
          ...
          <div style={containerStyles} className="w-full h-full flex flex-col gap-y-4 border-white rounded-tl-lg relative z-20">
