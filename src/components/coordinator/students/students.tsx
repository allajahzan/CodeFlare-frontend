...
function Students({ setDrawerOpen }: PropsType) {
  ...
  return (
    <div className="p-5 pt-0 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
      {/* Left side  */}
      <div
        className="p-5 sticky top-0 w-full h-[calc(100vh-108px)] flex flex-col gap-5 items-center rounded-2xl
      ...
      {!isSmall && (
        <div className="grid gap-5 col-auto lg:col-span-2 grid-rows-[auto_1fr]">
          ...
          <ReviewDetails selectedStudent={selectedStudent as IStudent} />
        </div>
      )}
    </div>
  );
