                ...
                {view === "table-view" && (
                    <div className="relative w-full sm:col-span-2 lg:col-span-1">
                        ...
                        >
                            <SelectTrigger
                                title="Date"
                                className="w-full sm:w-[252px] text-foreground font-medium p-5 pl-9 cursor-pointer bg-background hover:bg-muted dark:hover:bg-sidebar dark:hover:border-customBorder-dark"
                            >
